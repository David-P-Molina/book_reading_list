...
class UserBooksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_book" do
    assert_difference('UserBook.count') do
      post user_books_url, params: { user_book: { end_date: @user_book.end_date, finished: @user_book.finished, percent_read: @user_book.percent_read, start_date: @user_book.start_date, total_reading_time: @user_book.total_reading_time } }
    end
  ...
  test "should update user_book" do
    patch user_book_url(@user_book), params: { user_book: { end_date: @user_book.end_date, finished: @user_book.finished, percent_read: @user_book.percent_read, start_date: @user_book.start_date, total_reading_time: @user_book.total_reading_time } }
